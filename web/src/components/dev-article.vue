      ...
      >
        ...
        >
          <MenuGroup title="系统设置">
            <MenuItem class="hidden-nowrap" name="/home" to="/home" replace>
              <Icon type="md-document"/>
              <span>权限分配</span>
            </MenuItem>
            <MenuItem class="hidden-nowrap" name="/about" to="/about" replace>
              <Icon type="md-chatbubbles"/>
              <span>表单设计</span>
            </MenuItem>
          </MenuGroup>
          <MenuGroup title="数据采集">
            <MenuItem class="hidden-nowrap" name="/data" to="/data" replace>
              <Icon type="md-calendar"/>
              <span>数据列表</span>
            </MenuItem>
          </MenuGroup>
          <MenuGroup title="税费测算">
            <MenuItem class="hidden-nowrap" name="/count" to="/count" replace>
              <Icon type="md-analytics"/>
              <span>测算列表</span>
            </MenuItem>
          </MenuGroup>
          <MenuGroup title="协作成果">
            <MenuItem class="hidden-nowrap" name="/login" to="/login" replace>
